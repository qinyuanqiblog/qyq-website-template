<template>
  <div id="app">
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <!-- <a
                  href=""
                  class="iframe-popup"
                ><span class="icon icon_pin_alt"></span> 988782, Our Street, L.A.</a>
                <a href="#"><span class="icon icon_mail_alt"></span> clients@example.com</a> -->
                <a href="#"><span class="icon icon_phone"></span> 0771-5652300</a>
                <a href="#"><span class="icon icon_phone"></span> 18978919912‬‬</a>
              </div>
              <!-- /Feedback -->
    ...
    <div class="slider owl-carousel owl-theme">
      ...
      <div
        class="item mask"
        style="background: url(images/home.jpg) no-repeat center top / cover;"
      ...
      >
        ...
        <div class="container height-100p">
          <div class="row height-100p">
            ...
            <div
              class="col-sm-6 col-md-6 height-100p bounceInLeft wow"
              data-wow-duration="1.3s"
              data-wow-delay="0.3s"
              data-stellar-ratio="0.7"
            >
              <div class="vertical-middle">
                <h1 class="text-white">Welcome to <span class="text-theme">CleaThin</span></h1>
                ...
                <a
                  href="#about"
                  class="smooth-scroll btn btn-theme"
                >Start Watching</a>
              </div>
            </div>

            <div
              class="col-sm-6 col-md-4 col-md-offset-2 height-100p bounceInRight wow"
              data-wow-duration="1.3s"
      ...
      <div
        class="item mask"
        style="background: url(images/home-02.jpg) no-repeat center top / cover;"
        data-stellar-background-ratio="0.4"
      >
    ...
    <main class="main-container">
      ...
      >
        <div class="container">
          ...
          <div class="row">
            ...
            <!-- Feature Block -->
            <div
              class="col-sm-4 feature fadeIn wow"
              data-wow-duration="1.3s"
            >
      ...
      <section
        id="projects"
        class="section-small bg-light-gray"
      >
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <header>
                <h2 class="section-title"><span class="text-theme">我们的</span> 产品</h2>
                <p class="section-subtitle">产品描述 巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉巴拉</p>
              </header>
            </div>
          ...
          <div class="row mt">
            ...
            <div
              class="col-md-4 col-sm-6 fadeIn wow"
              data-wow-duration="1.3s"
            >
              <a
                href="images/project-01.jpg"
                class="project-item image-popup"
              >
      ...
      >
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <header class="text-center">
                <h2 class="section-title">Best Features in <span class="text-theme">This Project</span></h2>
                <p class="section-subtitle">It is a long established fact that a reader</p>
              </header>
            </div>
          </div>
          ...
          <div class="row section-content">
            ...
            <div class="col-md-6">
              ...
              <ul class="list">
                <li>
                  <h4
                    class="title bounceInUp wow"
                    data-wow-duration="1.3s"
                    data-wow-delay="0.2s"
                  >Clean Design</h4>
                  <p
                    class="description fadeIn wow"
                    data-wow-duration="1.3s"
                    data-wow-delay="0.2s"
                  >
            ...
            <!-- Section Image -->
            <div
              class="col-md-6 hidden-sm hidden-xs bounceInRight wow"
              data-wow-duration="1.3s"
            >
              <img
                src="images/devices.png"
                ...
                <div class="row">
                  <div class="form-group col-md-12 text-center">
                    <button
                      type="submit"
                      class="btn btn-theme"
                    ><i class="fa fa-fw fa-paper-plane-o"></i> Send Message</button>
                  </div>
                </div>
            ...
            <div class="ly_nr ">
              ...
              <div class="message">
                <div id="mess_main">
                  ...
                  <div class="mess_list">
                    <div class="mess_title fl">留言内容：</div>
                    <div class="mess_input fr">
                      <input
                        type="text"
                        name="content"
                  ...
                  <div class="mess_list">
                    <div class="mess_title fl">验证码：</div>
                    <div class="mess_input mess_with fr">
                      <input
                        type="text"
                        class="form-control"
                        placeholder="验证码"
                        style="color:black;width:120px;float:left;margin:0px 0px;"
                        name="code"
                        id="hcode"
                      >
                      <img
...
<script>
import { websiteHeader, websiteFooter, searchBox, contactSidebar, contactDialog, phoneService } from '@/components'
export default {
  name: 'index',
  components: {
    websiteHeader,
