  ...
  <div>
    ...
    >
      <div class="cd-popup-container3">
        <div class="cd_img"><img src="~/assets/images/concat-us-bg.jpg"></div>
        <div class="cd_you">
          <h4>请您留言咨询</h4>
          <h3>我们会尽快联系您</h3>
          <div class="kh_ly">
    ...
    <section class="customer-side">
      <ul>
        ...
        <li class="customer-sideewm"><i class="bgs3"></i>扫一扫<div class="sjzd son"><img :src="baseInfo.qrcode"></div>
        </li>
      </ul>
    </section>
  </div>
